...
var WeatherComponent = (function () {
    ...
    WeatherComponent.prototype.getCurrentLocation = function () {
        var _this = this;
        this.service.getCurrentLocation().subscribe(function (position) {
            _this.pos = position;
    ...
    WeatherComponent.prototype.getLocationName = function () {
        var _this = this;
        this.service.getLocationName(this.pos.coords.latitude, this.pos.coords.longitude).subscribe(function (location) {
            console.log(location);
            _this.currentLocation = location['results'][4]['formatted_address'];
            console.log('Location Name: ', _this.currentLocation);
        });
    };
    ;
